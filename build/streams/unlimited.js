...
var unlimitedStream = bot_1.default.stream('statuses/filter', {
...
unlimitedStream.on('disconnect', function (disconnectMessage) {
    logger_1.default.error("- UNLIMITED STREAM - ERROR - Desconectado - " + disconnectMessage);
    unlimitedStream.start();
});
unlimitedStream.on('connect', function () {
    logger_1.default.log("- UNLIMITED STREAM - DEBUG - Conectando");
});
unlimitedStream.on('connected', function () {
    logger_1.default.log("- UNLIMITED STREAM - DEBUG - Conectado");
});
unlimitedStream.on('warning', function (warning) {
    logger_1.default.warn("- UNLIMITED STREAM - WARN - " + warning);
});
